...
static const unsigned int nParts_ = 4;
static const std::array<std::string, nParts_> partitions_ = {{"TIB", "TOB", "TID", "TEC"}};
static const std::array<unsigned int, nParts_> layers_ = {{4, 6, 3, 9}};
static const std::array<unsigned int, nParts_> sides_ = {{1, 1, 2, 2}};
static const unsigned int nStrips_ = 768; // maximum number of strips per sensor
static const unsigned int nAPV_ = 6; // maximum number of APVs per sensor
static const unsigned int nStripsAPV_ = 128; // number of strips per APV



class SiStripSpyCMslope : public edm::one::EDAnalyzer<> {
